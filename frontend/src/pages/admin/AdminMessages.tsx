  ...
  return (
    <DashboardLayout config={adminNav}>
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">All Messages (Admin View)</h1>
        <p className="text-slate-600 dark:text-slate-400 mb-6">Monitor and manage all user conversations</p>
              ...
              {selectedUser ? (
                <>
                  ...
                  <div className="border-b pb-4 mb-4">
                    ...
                    <p className="text-xs text-slate-500">Admin monitoring conversation</p>
                  </div>
